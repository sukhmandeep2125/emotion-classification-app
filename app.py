...
from tensorflow.keras.layers import GRU, Bidirectional  # 👈 Necessary for deserialization

# If you used a custom attention layer, define it here again
...
# 👇 Add custom_objects when loading the model
model = load_model(
